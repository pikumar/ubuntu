...
# Install basics
os.system("apt install -y htop hexchat git make build-essential xclip python3-pip libcgal-dev locate cmake swig")
...
if not spath.is_file(): 
    ...
    cmd = "wget "+ durl +" && bzip2 -d sublime_text_3_build_3211_x64.tar.bz2 && tar xvf sublime_text_3_build_3211_x64.tar"
    print("Executing:", cmd)
    execute(cmd)
    execute("rm -f *.tar")
    ...
    execute("ln -sf ~/bin/sublime_text_3/sublime_text ~/bin/subl", asuser=parentuser)
else:
    print("Found")
